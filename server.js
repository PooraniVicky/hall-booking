...
let rooms = [];
let bookings = [];
let roomIdCounter = 1; // Counter to generate unique room IDs
let bookingIdCounter = 1; // Counter to generate unique booking IDs
...
app.post('/rooms', (req, res) => {
    ...
    const roomId = roomIdCounter++; // Increment the room ID counter for each new room
